...
// 20141213-002: Added log4j
		final Logger logger = Logger.getLogger(AppMainJdbc.class);
...
// EXERCISE: INSERT 'Tom','Smith',25,'M', '1975-01-15','any@email.com' into database
...
// EXERCISE:  INSERT 'Judy','Jones',38,'F', '1968-03-25','another@email.com' into database		
		person = new Person();
		address = new Address();
